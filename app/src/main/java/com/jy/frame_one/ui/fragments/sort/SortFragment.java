package com.jy.frame_one.ui.fragments.sort;
...
import com.jy.frame_one.adapter.SortAdapter;
...
import com.jy.frame_one.persenter.sort.SortPersenter;
import com.jy.frame_one.ui.activitys.SortDetailActivity;
...
public class SortFragment extends BaseFragment<SortConstract.Persenter> implements SortConstract.View,VerticalTabLayout.OnTabSelectedListener, BaseAdapter.ItemClickHandler {
    ...
    protected SortConstract.Persenter createPersenter() {
        return (SortConstract.Persenter) new SortPersenter();
    }
